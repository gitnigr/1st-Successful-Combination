...
import { formatAddress, formatMarketCap, formatTimeAgo } from "common/utils/format"
        ...
        />
          <Stack width="0" flexGrow={1} >
            ...
            <Stack p={1}>
              ...
              <Typography 
                variant="body2" 
                color={description === 'No description available' ? 'text.disabled' : 'text.secondary'}
                sx={{
                  display: '-webkit-box',
                  WebkitLineClamp: 2,
                  ...
                  mb: 1,
                  lineHeight: 1.3,
                  fontStyle: description === 'No description available' ? 'italic' : 'normal'
                }}
              >
                {description}
              </Typography>
              ...
              {renderParam("", formatTimeAgo(data.created_timestamp))}
