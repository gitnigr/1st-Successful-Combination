    ...
    return (
      <Stack p={2} pb={4} maxWidth={600} width="100%" mx="auto">
        ...
        <>
          ...
          <Typography 
            variant="body2" 
            color={(coin as any).description && (coin as any).description.trim() !== '' ? 'text.secondary' : 'text.disabled'}
            sx={{ 
              mb: 1,
              fontStyle: (!((coin as any).description && (coin as any).description.trim() !== '')) ? 'italic' : 'normal'
            }}
          >
            {(coin as any).description && (coin as any).description.trim() !== '' 
              ? (coin as any).description 
